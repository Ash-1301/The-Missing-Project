...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(useSprintBar)
        {
            if (sprintBarBG != null) if (sprintBarBG != null) sprintBarBG.gameObject.SetActive(false);
            ...
            if (sprintBarBG != null) sprintBarBG.rectTransform.sizeDelta = new Vector3(sprintBarWidth, sprintBarHeight, 0f);
            if (sprintBar != null) sprintBar.rectTransform.sizeDelta = new Vector3(sprintBarWidth - 2, sprintBarHeight - 2, 0f);
    ...
    private void Update()
    {
        ...
        if(enableSprint)
        {
            ...
            if(useSprintBar && !unlimitedSprint)
            {
                ...
                if (sprintBar != null) sprintBar.transform.localScale = new Vector3(sprintRemainingPercent, 1f, 1f);
            }
        }
